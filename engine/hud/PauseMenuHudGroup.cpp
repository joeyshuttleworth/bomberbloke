...
PauseMenuHudGroup::PauseMenuHudGroup()
  ...
  std::shared_ptr<TextButton> resumeElement = std::make_shared<TextButton>(resumeText, 0, -40, 200, 30, resumeFn, ALIGN_CENTER, ALIGN_CENTER);
  ...
  std::shared_ptr<Text> leaveText = textManager.createText("Aileron-Black", "LEAVE GAME");
  ...
  std::shared_ptr<TextButton> leaveElement = std::make_shared<TextButton>(leaveText, 0, 0, 200, 30, disconnectFn, ALIGN_CENTER, ALIGN_CENTER);
  ...
  std::shared_ptr<TextButton> optionsElement = std::make_shared<TextButton>(optionsText, 0, 40, 200, 30, optionsFunction, ALIGN_CENTER, ALIGN_CENTER);
...
void PauseMenuHudGroup::openOptionsMenu() {
...
void PauseMenuHudGroup::closeOptionsMenu() {
