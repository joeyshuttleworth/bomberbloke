...
net_flush_messages();
void
net_add_message(net_message*, bool);
void
net_handle_messages();
void
net_messages_init();
...
net_init();
void
net_float_create(double, net_float*);
void*
receive_loop(void*);
list_node*
net_get_message(unsigned int);
void
handle_datagram(char*, struct sockaddr_storage*, unsigned int, unsigned int);
void
net_join_server(const char*, char*, const char*);
void
net_remove_message(list_node*);
void
timeout(list_node*);
void
net_remove_messages_to(struct sockaddr_storage*);
void
net_clear_messages();
void
net_send_message();
