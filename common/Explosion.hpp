...
protected:
  ...
  const std::string mExplosionSoundNames[N_EXPLOSION_SOUNDS] = {"bomb1", "bomb2"};
public:
  int getType() const{
  ...
  Explosion(double x_pos, double y_pos, double x_dim, double y_dim, int speed = 30, int timeout = 2*TICK_RATE, int start_delay = 0, bool sound_on = true, int max_glow=255)
